...
\left(
    \begin{aligned}
        - \frac{\lambda}{2}\\
        \lambda u\\
        -\frac{1}{2}\lambda u ^ \mathrm{T} u + \frac{D}{2} \ln \lambda
    \end{aligned}
\right)
- \frac{D}{2}\ln2\pi \\
&+ \frac{D}{2}\ln\gamma - b\lambda + \frac{Da-D+2}{2}\ln b - \ln\Gamma\frac{Da -D + 2}{2}\\
& = \textbf{N}(x|\nu, (\gamma \lambda I)^{-1}) \textbf{Gamma}(\lambda | \frac{D \gamma - D + 2}{2}, b)
\end{aligned}
$$
